 ...
 *   { "name": "Alice",
 *     "htmlComment":
 *         "<span onmouseover='this.textContent=\"PWN3D!\"'>Is <i class="icon">anyone</i> reading this?</span>"
 *   },
 *   { "name": "Bob",
 *     "htmlComment": "<i class="icon">Yes!</i>  Am I the only other one?"
 *   }
 * ]
 * </file>
 *
 ...
 *           .toBe('<span>Is <i class="icon">anyone</i> reading this?</span>');
 *     });
 *
